...
The declared system consists of 23 component(s) and 58 connection(s) — see [the system map](../architecture/system-map.md). Anything not declared there is external to this system.
