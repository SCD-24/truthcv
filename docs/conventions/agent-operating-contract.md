...
The declared system consists of 25 component(s) and 82 connection(s) — see [the system map](../architecture/system-map.md). Anything not declared there is external to this system.
