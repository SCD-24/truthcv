<!-- generated:start edge:keyword-vocabulary→storage-leaf -->
# Interaction: Keyword Vocabulary → Storage

- **Participants:** `keyword-vocabulary` → `storage-leaf`
- **Transport:** `in-process`
<!-- generated:end edge:keyword-vocabulary→storage-leaf -->
