<!-- generated:start edge:services-layer→agent-config -->
# Interaction: Services Layer → Agent Config

- **Participants:** `services-layer` → `agent-config`
- **Transport:** `in-process`
<!-- generated:end edge:services-layer→agent-config -->
