<!-- generated:start edge:screening-engine→agent-config -->
# Interaction: Screening Engine → Agent Config

- **Participants:** `screening-engine` → `agent-config`
- **Transport:** `in-process`
<!-- generated:end edge:screening-engine→agent-config -->
