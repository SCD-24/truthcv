<!-- generated:start edge:secret-store→storage-leaf -->
# Interaction: Secret Store → Storage

- **Participants:** `secret-store` → `storage-leaf`
- **Transport:** `in-process`
<!-- generated:end edge:secret-store→storage-leaf -->
