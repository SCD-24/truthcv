<!-- generated:start edge:onboarding-store→truth-data-volume -->
# Interaction: Onboarding Store → Truth Data Volume

- **Participants:** `onboarding-store` → `truth-data-volume`
- **Transport:** `file I/O`
<!-- generated:end edge:onboarding-store→truth-data-volume -->
