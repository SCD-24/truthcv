<!-- generated:start edge:agent-config→storage-leaf -->
# Interaction: Agent Config → Storage

- **Participants:** `agent-config` → `storage-leaf`
- **Transport:** `in-process`
<!-- generated:end edge:agent-config→storage-leaf -->
