<!-- generated:start edge:job-feeds→secret-store -->
# Interaction: Job Feeds → Secret Store

- **Participants:** `job-feeds` → `secret-store`
- **Transport:** `in-process`
<!-- generated:end edge:job-feeds→secret-store -->
