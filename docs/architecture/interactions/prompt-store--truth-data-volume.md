<!-- generated:start edge:prompt-store→truth-data-volume -->
# Interaction: Prompt Store → Truth Data Volume

- **Participants:** `prompt-store` → `truth-data-volume`
- **Transport:** `file I/O`
<!-- generated:end edge:prompt-store→truth-data-volume -->
