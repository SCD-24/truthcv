<!-- generated:start edge:tailor-engine→keyword-vocabulary -->
# Interaction: Tailor Engine → Keyword Vocabulary

- **Participants:** `tailor-engine` → `keyword-vocabulary`
- **Transport:** `in-process`
<!-- generated:end edge:tailor-engine→keyword-vocabulary -->
