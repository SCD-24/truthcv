<!-- generated:start edge:application-tracker→company-research -->
# Interaction: Application Tracker → Company Research

- **Participants:** `application-tracker` → `company-research`
- **Transport:** `in-process`
<!-- generated:end edge:application-tracker→company-research -->
