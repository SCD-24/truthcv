<!-- generated:start edge:screening-engine→storage-leaf -->
# Interaction: Screening Engine → Storage

- **Participants:** `screening-engine` → `storage-leaf`
- **Transport:** `in-process`
<!-- generated:end edge:screening-engine→storage-leaf -->
