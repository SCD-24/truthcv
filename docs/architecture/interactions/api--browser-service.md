<!-- generated:start edge:api→browser-service -->
# Interaction: API → Browser Service

- **Participants:** `api` → `browser-service`
- **Transport:** `WebSocket (noVNC relay) + HTTP`
<!-- generated:end edge:api→browser-service -->
