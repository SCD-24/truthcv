<!-- generated:start edge:prompt-store→storage-leaf -->
# Interaction: Prompt Store → Storage

- **Participants:** `prompt-store` → `storage-leaf`
- **Transport:** `in-process`
<!-- generated:end edge:prompt-store→storage-leaf -->
