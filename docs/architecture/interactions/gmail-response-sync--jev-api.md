<!-- generated:start edge:gmail-response-sync→jev-api -->
# Interaction: Gmail Response Sync → Jev (TypeSafe System One) API

- **Participants:** `gmail-response-sync` → `jev-api`
- **Transport:** `HTTPS`
<!-- generated:end edge:gmail-response-sync→jev-api -->
