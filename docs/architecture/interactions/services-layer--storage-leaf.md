<!-- generated:start edge:services-layer→storage-leaf -->
# Interaction: Services Layer → Storage

- **Participants:** `services-layer` → `storage-leaf`
- **Transport:** `in-process`
<!-- generated:end edge:services-layer→storage-leaf -->
