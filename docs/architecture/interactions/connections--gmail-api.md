<!-- generated:start edge:connections→gmail-api -->
# Interaction: Connections → Gmail / Google OAuth API

- **Participants:** `connections` → `gmail-api`
- **Transport:** `HTTPS`
<!-- generated:end edge:connections→gmail-api -->
