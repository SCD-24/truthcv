<!-- generated:start edge:renderer→keyword-vocabulary -->
# Interaction: Renderer → Keyword Vocabulary

- **Participants:** `renderer` → `keyword-vocabulary`
- **Transport:** `in-process`
<!-- generated:end edge:renderer→keyword-vocabulary -->
