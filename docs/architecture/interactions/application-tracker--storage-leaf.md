<!-- generated:start edge:application-tracker→storage-leaf -->
# Interaction: Application Tracker → Storage

- **Participants:** `application-tracker` → `storage-leaf`
- **Transport:** `in-process`
<!-- generated:end edge:application-tracker→storage-leaf -->
