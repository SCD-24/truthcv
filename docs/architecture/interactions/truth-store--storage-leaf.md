<!-- generated:start edge:truth-store→storage-leaf -->
# Interaction: Truth Store → Storage

- **Participants:** `truth-store` → `storage-leaf`
- **Transport:** `in-process`
<!-- generated:end edge:truth-store→storage-leaf -->
