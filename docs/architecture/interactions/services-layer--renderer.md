<!-- generated:start edge:services-layer→renderer -->
# Interaction: Services Layer → Renderer

- **Participants:** `services-layer` → `renderer`
- **Transport:** `in-process`
<!-- generated:end edge:services-layer→renderer -->
