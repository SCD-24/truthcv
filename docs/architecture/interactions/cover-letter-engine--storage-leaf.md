<!-- generated:start edge:cover-letter-engine→storage-leaf -->
# Interaction: Cover Letter Engine → Storage

- **Participants:** `cover-letter-engine` → `storage-leaf`
- **Transport:** `in-process`
<!-- generated:end edge:cover-letter-engine→storage-leaf -->
